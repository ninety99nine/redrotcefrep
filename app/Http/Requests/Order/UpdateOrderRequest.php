...
class UpdateOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'subtotal_after_discount' => ['sometimes', 'numeric', 'min:0'],
            'vat_method' => ['sometimes', Rule::enum(TaxMethod::class)],
            'vat_rate' => ['sometimes', 'numeric', 'min:0', 'max:99.99'],
            'vat_amount' => ['sometimes', 'numeric', 'min:0'],
            'fee_total' => ['sometimes', 'numeric', 'min:0'],
            'adjustment_total' => ['sometimes', 'numeric'],
            ...
            'paid_percentage' => ['sometimes', 'integer', 'min:0', 'max:100'],
            'pending_total' => ['sometimes', 'numeric', 'min:0'],
            'pending_percentage' => ['sometimes', 'integer', 'min:0', 'max:100'],
            'outstanding_total' => ['sometimes', 'numeric', 'min:0'],
            'outstanding_percentage' => ['sometimes', 'integer', 'min:0', 'max:100'],
            'total_products' => ['sometimes', 'integer', 'min:0', 'max:65535'],
            'total_cancelled_products' => ['sometimes', 'integer', 'min:0', 'max:65535'],
            'total_uncancelled_products' => ['sometimes', 'integer', 'min:0', 'max:65535'],
            'total_product_quantities' => ['sometimes', 'integer', 'min:0', 'max:65535'],
            'total_cancelled_product_quantities' => ['sometimes', 'integer', 'min:0', 'max:65535'],
            'total_uncancelled_product_quantities' => ['sometimes', 'integer', 'min:0', 'max:65535'],
            'total_promotions' => ['sometimes', 'integer', 'min:0', 'max:65535'],
            'total_cancelled_promotions' => ['sometimes', 'integer', 'min:0', 'max:65535'],
            'total_uncancelled_promotions' => ['sometimes', 'integer', 'min:0', 'max:65535'],
            'applied_promotion_code' => ['sometimes', 'boolean'],
            'delivery_method_name' => ['sometimes', 'string', 'max:255'],
            'free_delivery' => ['sometimes', 'boolean'],
            'delivery_date' => ['sometimes', 'date'],
            'delivery_timeslot' => ['sometimes', 'string', 'max:255'],
            'delivery_method_id' => ['sometimes', 'uuid', 'exists:delivery_methods,id'],
            'delivery_distance_value' => ['sometimes', 'numeric', 'min:0'],
            'delivery_distance_unit' => ['sometimes', 'string', 'max:50'],
            'delivery_distance_text' => ['sometimes', 'string', 'max:255'],
            'delivery_duration_value' => ['sometimes', 'numeric', 'min:0'],
            'delivery_duration_text' => ['sometimes', 'string', 'max:255'],
            'delivery_weight_value' => ['sometimes', 'numeric', 'min:0'],
            'delivery_weight_unit' => ['sometimes', 'string', 'max:50'],
            'delivery_weight_text' => ['sometimes', 'string', 'max:255'],
            'courier_id' => ['nullable', 'uuid', 'exists:couriers,id'],
            'tracking_number' => ['nullable', 'string', 'max:255'],
            'collection_code' => ['sometimes', 'string', 'size:6'],
            'collection_qr_code' => ['sometimes', 'string', 'max:255'],
            'collection_code_expires_at' => ['sometimes', 'date'],
            'collection_verified' => ['sometimes', 'boolean'],
            'collection_verified_at' => ['sometimes', 'date'],
            'collection_verified_by_user_id' => ['sometimes', 'uuid', 'exists:users,id'],
            'collection_note' => ['sometimes', 'string'],
            ...
            'customer_mobile_number' => ['sometimes', 'string', 'max:20'],
            ...
            'total_views_by_team' => ['sometimes', 'integer', 'min:0', 'max:65535'],
            'first_viewed_by_team_at' => ['sometimes', 'date'],
            'last_viewed_by_team_at' => ['sometimes', 'date'],
