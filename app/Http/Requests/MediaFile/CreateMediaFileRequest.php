...
class CreateMediaFileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'mediable_type' => ['required', 'string', Rule::in(['user', 'store', 'store payment method', 'design card', 'product', 'category', 'transaction', 'order comment'])],
    ...
    public function messages(): array
    {
        return [
            ...
            'mediable_type.in' => 'The mediable type must be one of: ' . Arr::join(['user', 'store', 'store payment method', 'design card', 'product', 'category', 'transaction', 'order comment'], ', ', ' or '),
