...
class UpdateStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'alias' => ['sometimes', 'string', 'max:255', Rule::unique('stores', 'alias')->ignore($this->route('store')->id)],
            ...
            'google_analytics_id' => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^G-[A-Z0-9]+$/'],
            'meta_pixel_id' => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^[0-9]+$/'],
            'tiktok_pixel_id' => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^[A-Z0-9]+$/'],
        ];
    }
