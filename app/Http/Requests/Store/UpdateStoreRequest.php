...
class UpdateStoreRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'opening_hours.*.available.required_with' => 'The available status is required.',
            'opening_hours.*.available.boolean' => 'The available status must be a boolean.',
            'opening_hours.*.hours.required_with' => 'The opening hours are required.',
            'opening_hours.*.hours.array' => 'The opening hours must be an array.',
            'opening_hours.*.hours.*.array' => 'The opening hours must be an array.',
            'opening_hours.*.hours.*.*.required_with' => 'The opening hours are required.',
            'opening_hours.*.hours.*.*.string' => 'The opening hours must be a string.',
            'opening_hours.*.hours.*.*.regex' => 'The opening hours must be in HH:MM format (e.g., 17:00).',
