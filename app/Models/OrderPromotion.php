...
class OrderPromotion extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'minimum_total_products' => 'integer',
            'discount_percentage_rate' => 'integer',
            'minimum_total_product_quantities' => 'integer',
     ...
     */
    protected $fillable = [
        'name','description','offer_discount','discount_rate_type','discount_percentage_rate','discount_flat_rate',
        ...
        'minimum_total_product_quantities','activate_using_start_datetime','start_datetime','activate_using_end_datetime','end_datetime',
        'activate_using_hours_of_day','hours_of_day','activate_using_days_of_the_week','days_of_the_week','activate_using_days_of_the_month',
        'days_of_the_month','activate_using_months_of_the_year','months_of_the_year','activate_for_new_customer','activate_for_existing_customer',
        'activate_using_usage_limit','remaining_quantity','is_cancelled','cancellation_reasons','detected_changes','order_id','store_id','promotion_id',
    ];
