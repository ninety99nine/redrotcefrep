<template>
    ...
    <div class="relative select-none">
        ...
        <!-- Clouds Image -->
        <img :src="'/images/clouds.png'" class="absolute bottom-0 z-0">
        ...
        <div class="relative bg-white/80 p-4 rounded-md">
            ...
            <Table
                ...
                <template #noResults>
                    ...
                    <div class="flex justify-between items-center p-10 bg-blue-50 border-t border-blue-200">


                        <Loader v-if="isCreatingVariations">
                            <span class="ml-2">Creating variations</span>
                        </Loader>

                        <div v-else>
                            <h1 class="text-2xl font-bold mb-4">No variations</h1>
        ...
        methods: {
            ...
            async getProducts(page = 1) {
                ...
                try {
                    ...
                    const response = await axios.get(`/api/products/${this.product.id}/variations`, config);
                    ...
                    this.$emit('totalProductVariations', this.pagination.meta.total);
