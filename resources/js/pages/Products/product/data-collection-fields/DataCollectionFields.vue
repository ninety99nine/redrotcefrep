    ...
    <div>
        ...
        <div :class="['space-y-4', { 'mt-4' : productForm.data_collection_fields.length < 2 }]">
                ...
                <div
                    ...
                    <div v-if="productForm.data_collection_fields[index].is_editable" class="space-y-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <Type v-if="dataCollectionField.type == 'text'" size="20"></Type>
                            ...
                            <Image v-if="dataCollectionField.type == 'media'" size="20"></Image>
                        ...
                        <div class="flex items-center justify-between space-x-8">
                            ...
                            <Input
                                class="w-full"
                                placeholder="Name"
                                v-model="productForm.data_collection_fields[index].name"
                                @input="productState.saveStateDebounced('Option name changed')"
                                :errorText="formState.getFormError('data_collection_fields'+index+'name')">
                            </Input>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <!-- Enable Quantity Checkbox -->
                                <Input
                                    type="checkbox"
                                    class="whitespace-nowrap"
                                    inputLabel="Enable quantity"
                                    v-if="supportsOptions(dataCollectionField)"
                                    v-model="productForm.data_collection_fields[index].enable_quantity"
                                    @change="productState.saveStateDebounced('Enable quantity status changed')"
                                    :errorText="formState.getFormError('data_collection_fields'+index+'enable_quantity')">
                                </Input>
                    ...
                    <div v-else class="space-y-2" @click="productForm.data_collection_fields[index].is_editable = true">
                        ...
                        <div class="flex items-center space-x-2 text-sm text-gray-500">
                            ...
                            <!-- Name -->
                            <span v-if="dataCollectionField.name">{{ dataCollectionField.name }}</span>
            ...
            <div :class="[{'flex space-x-2 justify-between' : !hasFields}]">
                ...
                <p v-if="!hasFields" class="text-sm text-gray-700">Add options if your product must capture additional information from the customer</p>
        ...
        <Modal
            ...
            <template #content v-if="deletableDataCollectionField">
                ...
                <div v-if="deletableDataCollectionField.name" class="flex items-start space-x-2 border border-gray-300 rounded-lg p-2 mb-4">
                    ...
                    <!-- Icon -->
                    <Type v-if="deletableDataCollectionField.type == 'text'" size="20"></Type>
                    ...
                    <Image v-if="deletableDataCollectionField.type == 'media'" size="20"></Image>

                    <!-- Name -->
                    <span class="text-sm">{{ deletableDataCollectionField.name }}</span>
