    ...
    <div>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="w-full flex items-center space-x-4 ">
                ...
                <!-- Store Name and Link -->
                <div class="w-full">
                    <Skeleton v-if="isLoadingStore || isLoadingOrder" width="w-20" :shine="true" class="mb-4"></Skeleton>
        ...
        <div
            ...
            v-if="isLoadingStore || isLoadingOrder || store.email || store.whatsapp_mobile_number">
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-1 text-sm">
                ...
                <div
                    ...
                    v-if="isLoadingStore || isLoadingOrder || order.delivery_method_name">
        ...
        <div class="border border-gray-300 rounded overflow-hidden mb-6">
            ...
            <table class="w-full text-xs text-left">
                ...
                <tbody>
                    <tr v-if="isLoadingStore || isLoadingOrder">
            ...
            <div class="w-full md:w-3/4 lg:w-1/2">
                ...
                <table class="w-full text-sm">
                    ...
                    <tr class="border-b border-gray-300 border-dashed">
                        ...
                        <td v-if="isLoadingStore || isLoadingOrder" class="w-24 pl-4"><Skeleton width="w-full" :shine="true"></Skeleton></td>
                        <td v-else class="text-right py-1">{{ order.subtotal.amount_with_currency }}</td>
                    </tr>

                    <tr
                        class="border-b border-gray-300 border-dashed"
                        v-if="isLoadingStore || isLoadingOrder || (order && order.discount_total.amount > 0)">
                    ...
                    <tr
                        class="border-b border-gray-300 border-dashed"
                        v-if="isLoadingStore || isLoadingOrder || (order && order.vat_amount > 0)">
                    ...
                    <tr
                        class="border-b border-gray-300 border-dashed"
                        v-if="isLoadingStore || isLoadingOrder || (order && order.fee_total.amount > 0)">
        ...
        <div class="border-b border-gray-200 pb-4">
            ...
            <Skeleton v-if="isLoadingStore || isLoadingOrder" :shine="true" class="mb-2"></Skeleton>
