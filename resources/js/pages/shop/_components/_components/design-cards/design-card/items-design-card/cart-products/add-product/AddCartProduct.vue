...
<script>
    ...
    import CartProductOptions from '@Pages/shop/_components/_components/design-cards/design-card/items-design-card/cart-products/add-product/cart-product-options/CartProductOptions.vue';
    import CartProductVariationOptions from '@Pages/shop/_components/_components/design-cards/design-card/items-design-card/cart-products/add-product/cart-product-variation-options/CartProductVariationOptions.vue';

    export default {
        inject: ['formState', 'orderState', 'storeState', 'notificationState'],
        components: { Input, Modal, Button, Skeleton, CartProductOptions, CartProductVariationOptions },
        data() {
            return {
                Plus,
                ArrowLeft,
        ...
        methods: {
            ...
            onSelectProduct(product, parentProduct) {
                ...
                if(hasVariants) {
                    ...
                    this.orderState.addCartProductUsingProduct(product, parentProduct, null, false);
                }
