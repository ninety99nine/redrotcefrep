<template>
    ...
    <div class="space-y-2">
        ...
        <div :class="[{ 'mb-20' : placement == 'storefront' }]">
...
<script>
    ...
    import LogoDesignCard from '@Pages/shop/_components/_components/design-cards/design-card/LogoDesignCard.vue';
    ...
    import BannerDesignCard from '@Pages/shop/_components/_components/design-cards/design-card/BannerDesignCard.vue';
    import ContactDesignCard from '@Pages/shop/_components/_components/design-cards/design-card/ContactDesignCard.vue';
    import DividerDesignCard from '@Pages/shop/_components/_components/design-cards/design-card/DividerDesignCard.vue';
