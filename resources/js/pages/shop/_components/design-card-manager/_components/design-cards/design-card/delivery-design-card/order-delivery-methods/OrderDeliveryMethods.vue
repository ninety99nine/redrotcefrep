...
<script>
    ...
    import OrderDeliveryMethod from '@Pages/shop/_components/design-card-manager/_components/design-cards/design-card/delivery-design-card/order-delivery-methods/OrderDeliveryMethod.vue';
