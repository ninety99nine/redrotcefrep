...
<script>
    ...
    import CartProduct from '@Pages/shop/_components/design-card-manager/_components/design-cards/design-card/items-design-card/cart-products/CartProduct.vue';
    import AddCartProduct from '@Pages/shop/_components/design-card-manager/_components/design-cards/design-card/items-design-card/cart-products/add-product/AddCartProduct.vue';

    export default {
        inject: ['storeState', 'orderState'],
        components: { Skeleton, CartProduct, AddCartProduct },
        computed: {
            isLoadingStore() {
