...
<script>
    ...
    import OrderTotals from '@Pages/shop/_components/design-card-manager/_components/design-cards/design-card/order-summary-design-card/order-totals/OrderTotals.vue';
