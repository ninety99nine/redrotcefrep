...
<script>
    ...
    import OrderProduct from '@Pages/orders/order/editable/components/products/OrderProduct.vue';
    import AddProduct from '@Pages/orders/order/editable/components/products/add-product/AddProduct.vue';

    export default {
        inject: ['storeState', 'orderState', 'shoppingCartState'],
        components: { Skeleton, AddProduct, OrderProduct },
        computed: {
            hasOrder() {
            ...
            cartProducts() {
                return this.shoppingCartState.shoppingCartForm.cart_products;
            },
            isEditting() {
