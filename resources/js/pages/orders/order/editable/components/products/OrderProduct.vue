        ...
        <div class="w-full flex space-x-4">
            ...
            <div class="w-full space-y-4">
                ...
                <Input
                    ...
                    @input="shoppingCartState.saveStateDebounced('Product name changed')">
                </Input>
                        ...
                        <tr>
                            <td class="whitespace-nowrap align-top py-2 pr-2">
                                ...
                                <Input
                                    ...
                                    @input="shoppingCartState.saveStateDebounced('Product regular price changed')">
                                </Input>
                            ...
                            <td class="whitespace-nowrap align-top p-2">
                                ...
                                <Input
                                    ...
                                    @input="shoppingCartState.saveStateDebounced('Product sale price changed')">
                                </Input>
                            ...
                            <td class="whitespace-nowrap align-top py-2 pl-2">
                                ...
                                <Input
                                    ...
                                    @input="shoppingCartState.saveStateDebounced('Product quantity changed')">
                                </Input>
            ...
            <div class="col-span-1">
                ...
                <div class="flex justify-end">
                    ...
                    <Button
                        ...
                        type="danger"
                        :leftIcon="Trash2"
                        :action="() => shoppingCartState.removeCartProduct(index)">
