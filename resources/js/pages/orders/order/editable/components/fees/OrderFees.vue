...
<script>
    ...
    import OrderFee from '@Pages/orders/order/editable/components/fees/OrderFee.vue';
    ...
    export default {
        ...
        computed: {
            ...
            cartFees() {
                return this.shoppingCartState.shoppingCartForm.cart_fees;
            },
            isEditting() {
        ...
        methods: {
            addNew() {
                this.shoppingCartState.addCartFee();
            }
        }
    };
