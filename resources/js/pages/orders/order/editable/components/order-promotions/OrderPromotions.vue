...
<script>
    ...
    import OrderPromotion from '@Pages/orders/order/editable/components/order-promotions/OrderPromotion.vue';
    import AddPromotion from '@Pages/orders/order/editable/components/order-promotions/add-promotion/AddPromotion.vue';
    ...
    export default {
        ...
        computed: {
            ...
            cartPromotions() {
                return this.orderState.orderForm.cart_promotions;
            },
            isEditting() {
