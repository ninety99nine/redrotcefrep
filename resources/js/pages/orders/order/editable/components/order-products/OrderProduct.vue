    ...
    <div class="rounded-lg overflow-hidden border border-gray-300 py-2 px-4 bg-gray-50">
        ...
        <div class="w-full flex space-x-4">
            ...
            <div :class="['flex items-center justify-center w-16 h-16 rounded-lg', { 'border border-dashed border-gray-200' : !hasPhotoPath }]">
                ...
                <img v-if="hasPhotoPath" class="w-full object-contain rounded-lg shrink-0" :src="photoPath">

                <svg v-else class="w-6 h-6 text-gray-400 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
