...
<script>
    ...
    import OrderDeliveryMethod from '@Pages/orders/order/editable/components/delivery-methods/OrderDeliveryMethod.vue';
    import OrderNoneDeliveryMethod from '@Pages/orders/order/editable/components/delivery-methods/OrderNoneDeliveryMethod.vue';
