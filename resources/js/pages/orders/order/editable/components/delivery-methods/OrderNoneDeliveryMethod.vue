<template>
    ...
    <div
        ...
        class="flex justify-between items-center cursor-pointer p-4 bg-gray-50 border border-gray-300 rounded-lg transition-colors group">
    ...
    export default {
        ...
        computed: {
            isSelectedDeliveryMethod() {
                return this.shoppingCartState.shoppingCartForm.delivery_method_id === null;
            }
        },
        methods: {
            unselectDeliveryMethod() {
                this.shoppingCartState.shoppingCartForm.delivery_method_id = null;
                this.shoppingCartState.saveStateDebounced('Delivery method removed');
            }
        }
    };
