        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <h1 v-else class="text-xl text-gray-700 font-semibold">
                    {{ isCreating ? 'Add Order' : 'Order #'+order.number }}
                </h1>
...
<script>
    ...
    import CreateOrderButton from '@Pages/orders/order/components/order-header/CreateOrderButton.vue';
    import SaveChangesButton from '@Pages/orders/order/components/order-header/SaveChangesButton.vue';
    import ChangeHistoryNavigation from '@Pages/orders/order/components/order-header/change-history-navigation/ChangeHistoryNavigation.vue';
