                ...
                <template
                    ...
                    <div
                        ...
                        <div class="flex space-x-2 items-center">
                            ...
                            <svg v-if="whatsappAction.label == 'Write message'" class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                            </svg>

                            <svg v-if="whatsappAction.label == 'Request review'" class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                            </svg>

                            <svg v-if="whatsappAction.label == 'Share order details'" class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M7.217 10.907a2.25 2.25 0 1 0 0 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.77-.283 1.093m0-2.186 9.566-5.314m-9.566 7.5 9.566 5.314m0 0a2.25 2.25 0 1 0 3.935 2.186 2.25 2.25 0 0 0-3.935-2.186Zm0-12.814a2.25 2.25 0 1 0 3.933-2.185 2.25 2.25 0 0 0-3.933 2.185Z" />
                            </svg>

                            <svg v-if="whatsappAction.label == 'Remind about payment'" class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m15 15-6 6m0 0-6-6m6 6V9a6 6 0 0 1 12 0v3" />
                            </svg>

                            <svg v-if="whatsappAction.label == 'Request proof of payment'" class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m9 14.25 6-6m4.5-3.493V21.75l-3.75-1.5-3.75 1.5-3.75-1.5-3.75 1.5V4.757c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0 1 11.186 0c1.1.128 1.907 1.077 1.907 2.185ZM9.75 9h.008v.008H9.75V9Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm4.125 4.5h.008v.008h-.008V13.5Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                            </svg>

                            <svg v-if="whatsappAction.label == 'Send payment confirmation'" class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
                            </svg>

                            <svg v-if="whatsappAction.label == 'Send completion confirmation'" class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            </svg>

                            <svg v-if="whatsappAction.label == 'Send cancellation confirmation'" class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M10.05 4.575a1.575 1.575 0 1 0-3.15 0v3m3.15-3v-1.5a1.575 1.575 0 0 1 3.15 0v1.5m-3.15 0 .075 5.925m3.075.75V4.575m0 0a1.575 1.575 0 0 1 3.15 0V15M6.9 7.575a1.575 1.575 0 1 0-3.15 0v8.175a6.75 6.75 0 0 0 6.75 6.75h2.018a5.25 5.25 0 0 0 3.712-1.538l1.732-1.732a5.25 5.25 0 0 0 1.538-3.712l.003-2.024a.668.668 0 0 1 .198-.471 1.575 1.575 0 1 0-2.228-2.228 3.818 3.818 0 0 0-1.12 2.687M6.9 7.575V12m6.27 4.318A4.49 4.49 0 0 1 16.35 15m.002 0h-.002" />
                            </svg>

                            <svg v-if="whatsappAction.label == 'Send thank you message'" class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.182 15.182a4.5 4.5 0 0 1-6.364 0M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Z" />
                            </svg>

                            <svg v-if="whatsappAction.label == 'Suggest another option'" class="w-4 h-4 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <Modal
            ...
            <template #content>
                ...
                <div class="flex items-center space-x-2 mb-4">
                    ...
                    <Pill :type="activeTab == 'edit' ? 'primary' : 'light'" size="md" :action="selectEditTab">Edit</Pill>
                    <Pill :type="activeTab == 'preview' ? 'primary' : 'light'" size="md" :action="selectPreviewTab">Preview</Pill>
        ...
        methods: {
            ...
            setWhatsappMessage() {
                ...
                const messages = {
                    ...
                    'Request proof of payment': `Hello ${this.order.customer_first_name}, could you please send us the proof of payment for order #${this.order.number}? This will help us process your order faster. Thank you!`,

                    'Send payment confirmation': `Hello ${this.order.customer_first_name}, we've received your payment for order #${this.order.number}. Your order is now being processed. Thank you for your prompt payment!`,

                    'Send completion confirmation': `Hello ${this.order.customer_first_name}, your order (#${this.order.number}) has been completed successfully! We hope you enjoy your meal. Thank you for ordering with us!`,

                    'Send cancellation confirmation': `Hello ${this.order.customer_first_name}, your order (#${this.order.number}) has been cancelled. If you have any questions or need further assistance, feel free to reach out to us.`,

                    'Send thank you message': `Hello ${this.order.customer_first_name}, thank you for your order! We truly appreciate your support and look forward to serving you again. Have a great day!`,

                    'Write message': `Write anything to ${this.order.customer_first_name}`
                };
                ...
                if(this.whatsappAction == 'Share order details') {
                    ...
                    this.whatsappFields.forEach(field => {
                        ...
                        if (field.active) {
                            ...
                            switch (field.name) {
                                case "Number":
                                    orderMessage += `${this.order.number}\n`;
                                    break;
                                case "Customer":
                                    orderMessage += `${this.order.customer_name}\n`;
                                    break;
                                case "Summary":
                                ...
                                case "Collection Status":
                                    ...
                                    break;
                                case "Grand Total":
                                    orderMessage += `${this.order.grand_total.amount_with_currency}\n`;
                                    break;
                                case "Paid":
                                ...
                                case "Outstanding":
                                    ...
                                    break;
                                case "Customer Note":
                                    orderMessage += `${this.order.customer_note || 'None'}\n`;
                                    break;
                                case "Created Date":
                                    orderMessage += `${this.order.created_at}\n`;
                                    break;
                                case "Order Link":
