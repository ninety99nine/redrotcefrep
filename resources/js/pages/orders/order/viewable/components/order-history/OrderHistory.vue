<template>
    ...
    <div class="bg-white rounded-lg p-4 mb-4">
        ...
        <div class="relative">
            ...
            <div class="max-h-80 overflow-y-auto py-4 px-4 border-t border-b border-gray-300">
                ...
                <div v-else class="text-gray-700 space-y-6">
                    ...
                    <div
                        ...
                        <div class="w-4 h-4 bg-gray-300 rounded-full absolute left-[-15px] top-0.5"></div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            orderHistory() {
                return this.isLoadingOrder ? [] : this.order.order_history;
            },
            groupedOrderHistory() {
