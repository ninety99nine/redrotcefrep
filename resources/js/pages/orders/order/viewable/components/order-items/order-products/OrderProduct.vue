<template>
    ...
    <div
        :class="[{ 'shadow-md' : expanded }, 'select-none rounded-lg overflow-hidden border border-gray-300']">

        <div
            @click="toggleExpansion"
            :class="[{ 'shadow-sm border-b border-gray-300' : expanded }, 'flex justify-between items-center cursor-pointer p-2 bg-gray-50 hover:bg-gray-100']">

            <div class="w-full flex items-center space-x-4">

                <div :class="['flex items-center justify-center w-10 h-10 rounded-lg', { 'border border-dashed border-gray-200' : !hasPhoto }]">

                    <img v-if="hasPhoto" class="w-full max-h-full object-contain rounded-lg flex-shrink-0" :src="photo.file_path">
                ...
                <div class="w-full flex items-center justify-between">
                    ...
                    <div>
                        <div
                            ...
                            class="flex items-center space-x-2 hover:text-blue-500 hover:underline">
                            <span class="font-semibold text-sm whitespace-nowrap">{{ orderProduct.quantity }} x</span>
                            <span class="text-sm font-semibold">{{ orderProduct.name }}</span>
                        </div>
                        <div class="text-xs text-gray-500">{{ orderProduct.unit_price.amount_with_currency }} each</div>
                    </div>
        ...
        <div v-if="expanded" class="text-sm p-4 pb-8">
            ...
            <div class="flex items-end justify-between mb-4 ml-4">
                ...
                <h1 class="text-sm text-gray-500 font-semibold">Pricing</h1>
            ...
            <template v-if="orderProduct.unit_weight > 0">

                <h1 class="text-sm text-gray-500 font-semibold mb-4 ml-4">Weight</h1>
