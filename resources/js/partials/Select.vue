                ...
                <div v-else class="w-full relative" ref="dropdown">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between py-2 px-3">
                            ...
                            <svg v-else-if="isOpen" @click.stop="toggleDropdown" class="w-4 h-4 text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
                            </svg>
                            <svg v-else @click.stop="toggleDropdown" class="w-4 h-4 text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
